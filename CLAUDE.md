...
- **[index.html](index.html)** — markup only. Links section is hardcoded here; edit `<a class="link-item">` blocks to add/remove hotlinks. Favicon URLs use `https://www.google.com/s2/favicons?domain=<domain>&sz=32`.
